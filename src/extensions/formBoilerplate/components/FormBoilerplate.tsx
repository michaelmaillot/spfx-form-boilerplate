...
import {
  ...
  IDropdownOption, IPersonaProps, ITheme, Label, MessageBar, MessageBarType,
...
export default class FormBoilerplate extends React.Component<IFormBoilerplateProps, IFormBoilerplateState> {
  ...
  public render(): React.ReactElement<{}> {
    ...
    return (
      <form onSubmit={this._saveItem} className={styles.formBoilerplate}>
  ...
  private _renderSaveButton = (item: ICommandBarItemProps): React.ReactNode => {
    return <PrimaryButton type="submit" className={styles.commandBarItems} styles={item.buttonStyles} text={item.text} iconProps={item.iconProps} />
  }
